...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "setting", "ws", "ws2", "4", "SNS", "CP-c", "CP-b", "browse", "write" }
    local l = awful.layout.suit
    local layouts = { l.tile, l.tile, l.tile, l.fair, l.max, l.tile, l.max, l.tile.floating, l.floating }
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "r", function () awful.spawn('rofi -show combi -combi-modes "window,drun"') end, {description = "drun rofi", group = "launcher"}),
    ...
    -- logout
    awful.key({ modkey }, "q", function() logout_popup.launch() end,
              {description = "show the logout menu", group = "custom"}),

    -- Print
    awful.key({ }, "Print", function() awful.util.spawn("scrot -e 'mv $f ~/ScreenShots/ 2>/dev/null'",false) end,
              {description = "capture all screen", group = "screenshot"}),
    awful.key({ "Shift" }, "Print", function() awful.util.spawn("scrot -u -e 'mv $f ~/ScreenShots/ 2>/dev/null'",false) end,
              {description = "capture current window", group = "screenshot"}),
    awful.key({ "Control" }, "Print", function() awful.util.spawn("scrot -s -e 'mv $f ~/ScreenShots/ 2>/dev/null'", false) end,
              {description = "capture selected window", group = "screenshot"})
)
